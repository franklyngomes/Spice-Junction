...
const categorySlice = createSlice({
  ...
  initialState: { items: [], loading: false, error: null, activeSubCategoryId: null },
  reducers: {
    setActiveSubCategoryId(state, action) {
      state.activeSubCategoryId = action.payload || null
    },
    clearActiveSubCategory(state) {
...
export const { setActiveSubCategoryId, clearActiveSubCategory } = categorySlice.actions
