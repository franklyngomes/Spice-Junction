...
export default function Discover() {
  ...
  const img = '/image/discover-curry.jpg'
  const accent = '#c62828'
        ...
        <Grid container spacing={{ xs: 4, md: 8 }} alignItems="center">
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              ...
              >
                Indian cuisine is a fiery celebration of flavors, where every dish tells a story of
                spice, tradition, and passion. Our chefs blend fresh ingredients and time-honored
                techniques to bring authentic taste to your table.
              </Typography>
