...
import "../styles/PageSection.css"; // your CSS
...
export default function PageSection() {
  ...
  return (
    <Container maxWidth="lg" className="pages-container">
      ...
      {/* ====== LEFT IMAGE + RIGHT TEXT (text bottom-aligned) ====== */}
      <Grid container spacing={4} alignItems="stretch" className="section-box">
        ...
        <CardMedia
          ...
          sx={{
            float: "right",
            width: "100%", // Adjust width as needed (e.g., 40-60% for right-side positioning)
            height: 450,
            objectFit: "fill",
            marginLeft: 2, 
            clear: "both", 
      ...
      {/* ====== MIDDLE SECTION: Text (downward/bottom-aligned) + Floated Image on Right ====== */}
