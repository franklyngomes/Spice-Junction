...
ApiRouter.get("/customer-order-history/:id",AuthCheck,CheckPermission(["view_order"]), OrderController.customerOrderHistory)
ApiRouter.get("/customer-pending-order/:id",AuthCheck,CheckPermission(["view_order"]), OrderController.getPendingOrderByCustomer)
